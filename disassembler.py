...
class Disassembler:
    ...
    def disassemble(self, *, pique_bool: bool = True) -> None:
        ...
        self.logger.debug(f"Disassembler exist status: {disassembler_exit_status}")
        if disassembler_exit_status != 0:
            ...
            self.logger.info(
                f'Generated {disassembler_output_file_name} at the directory {disassembler_output_file_directory}')
