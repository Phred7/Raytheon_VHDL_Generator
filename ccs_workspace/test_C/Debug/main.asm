...
;* Date/Time created: Tue Nov  9 11:23:24 2021                                *
;******************************************************************************
...
;	C:\ti\ccs1040\ccs\tools\compiler\ti-cgt-msp430_20.2.5.LTS\bin\acpia430.exe -@C:\\Users\\wward\\AppData\\Local\\Temp\\{4F5DCCEE-75B6-4BD0-9DD2-670C0118CCFC} 
	.sect	".text:main"
	.clink
	.global	main
...
$C$DW$3	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$3, DW_AT_decl_line(0x02)
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../main.c",line 4,column 5,is_stmt,isa 0
        BIC.W     #1,&PM5CTL0+0         ; [] |4| 
	.dwpsn	file "../main.c",line 5,column 11,is_stmt,isa 0
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP $C$L1
;*
;*   Loop source line                : 5
;*   Loop closing brace source line  : 5
...
;* --------------------------------------------------------------------------*
	...
	.dwattr $C$DW$3, DW_AT_TI_end_line(0x06)
