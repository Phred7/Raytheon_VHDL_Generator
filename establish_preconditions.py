...
class Preconditions:
    ...
    @staticmethod
    def recursively_search_for_nodes_with_tag_attrib(node, nodes: List, tag: str, attribute: str = None,value: str = None):
        """
    ...
    def establish_preconditions(project: CCSProject) -> None:
        ...
        Preconditions.recursively_search_for_nodes_with_tag_attrib(tree.getroot(), artifactExtensionNodes, "configuration", "artifactExtension")
        ...
        siliconVersionNodes = []
        Preconditions.recursively_search_for_nodes_with_tag_attrib(tree.getroot(), siliconVersionNodes, "option", "id", "com.ti.ccstudio.buildDefinitions.MSP430_20.2.compilerID.SILICON_VERSION.")
