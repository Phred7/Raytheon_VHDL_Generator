...
;* Date/Time created: Mon Feb  7 16:13:37 2022                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../empty_c_file.c")
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("C:\Users\wward\Documents\GitHub\Raytheon_VHDL_Generator\ccs_workspace\empty_c_file\Debug")
...
;	C:\ti\ccs1040\ccs\tools\compiler\ti-cgt-msp430_20.2.5.LTS\bin\opt430.exe C:\\Users\\wward\\AppData\\Local\\Temp\\{CB079717-AE86-4CE0-B092-5240A32707AF} C:\\Users\\wward\\AppData\\Local\\Temp\\{687BB262-A64A-4988-9E59-1E25C67972B5} 
	.sect	".text:main"
	.clink
	.global	main
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../empty_c_file.c",line 9,column 5,is_stmt,isa 0
        MOV.W     #23168,&WDTCTL+0      ; [] |9| 
	.dwpsn	file "../empty_c_file.c",line 10,column 2,is_stmt,isa 0
        MOV.W     #0,r12                ; [] |10| 
	.dwpsn	file "../empty_c_file.c",line 11,column 1,is_stmt,isa 0
$C$DW$3	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$3, DW_AT_TI_return
        ...
        RET       ; [] 
        ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("../empty_c_file.c")
