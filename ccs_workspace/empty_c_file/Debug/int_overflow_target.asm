...
;* Date/Time created: Mon Jan 24 15:41:55 2022                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../int_overflow_target.c")
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("C:\Users\wward\Documents\GitHub\Raytheon_VHDL_Generator\ccs_workspace\int_overflow_target\Debug")
;	C:\ti\ccs1040\ccs\tools\compiler\ti-cgt-msp430_20.2.5.LTS\bin\opt430.exe C:\\Users\\wward\\AppData\\Local\\Temp\\{A49FA7AD-48C9-4B0C-9AA3-AB36CAC4C4B6} C:\\Users\\wward\\AppData\\Local\\Temp\\{ADC1BD35-6CE1-428E-BCE6-F5D134B00576} 
	.sect	".text:main"
	.clink
	.global	main
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../int_overflow_target.c",line 9,column 2,is_stmt,isa 0
        MOV.W     #0,r12                ; [] |9| 
	.dwpsn	file "../int_overflow_target.c",line 10,column 1,is_stmt,isa 0
$C$DW$2	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$2, DW_AT_TI_return
        ...
        RET       ; [] 
        ; [] 
	.dwattr $C$DW$1, DW_AT_TI_end_file("../int_overflow_target.c")
	.dwattr $C$DW$1, DW_AT_TI_end_line(0x0a)
