...
;* Date/Time created: Wed Apr 27 22:35:46 2022                                *
;******************************************************************************
...
;	C:\ti\ccs1040\ccs\tools\compiler\ti-cgt-msp430_20.2.5.LTS\bin\acpia430.exe -@C:\\Users\\wward\\AppData\\Local\\Temp\\{6D409174-FFA1-4CB9-BDD3-E25B3A9340B3} 
...
$C$DW$39	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 86,column 5,is_stmt,isa 0
        OR.B      #4,&P3DIR+0           ; [] |86| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 87,column 2,is_stmt,isa 0
        BIC.B     #4,&P3OUT+0           ; [] |87| 
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 92,column 5,is_stmt,isa 0
        OR.B      #2,&P4IES+0           ; [] |92| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 93,column 5,is_stmt,isa 0
        BIC.B     #2,&P4IFG+0           ; [] |93| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 94,column 5,is_stmt,isa 0
        OR.B      #2,&P4IE+0            ; [] |94| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 95,column 5,is_stmt,isa 0
        EINT      ; [] |95| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 97,column 11,is_stmt,isa 0
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP $C$L1
;*
;*   Loop source line                : 97
...
$C$DW$40	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 107,column 36,is_stmt,address ISR_TB0CCR0,isa 0
...
$C$DW$42	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 113,column 36,is_stmt,address ISR_TB0CCR1,isa 0
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 115,column 5,is_stmt,isa 0
        BIC.B     #1,&P3OUT+0           ; [] |115| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 116,column 5,is_stmt,isa 0
        BIC.W     #1,&TB0CCTL1+0        ; [] |116| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 117,column 1,is_stmt,isa 0
...
$C$DW$44	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 121,column 37,is_stmt,address ISR_EUSCI_A1,isa 0
...
$C$DW$45	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 125,column 5,is_stmt,isa 0
        AND.W     #1,0(SP)              ; [] |125| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 127,column 5,is_stmt,isa 0
        CMP.W     #1,0(SP)              ; [] |127| 
        JNE       $C$L8                 ; [] |127| 
                                          ; [] |127| 
;* --------------------------------------------------------------------------*
...
$C$DW$47	.dwtag  DW_TAG_variable
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 128,column 22,is_stmt,isa 0
        MOV.W     &UCA1RXBUF+0,2(SP)    ; [] |128| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 129,column 9,is_stmt,isa 0
        CMP.W     #49,&UCA1RXBUF+0      ; [] |129| 
        JNE       $C$L3                 ; [] |129| 
                                          ; [] |129| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../keyboard_control_main_capstone.c",line 130,column 1,is_stmt,isa 0
        CMP.B     #1,&sw_trigger_flag+0 ; [] |130| 
        JNE       $C$L2                 ; [] |130| 
                                          ; [] |130| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../keyboard_control_main_capstone.c",line 130,column 31,is_stmt,isa 0
        OR.B      #4,&P3OUT+0           ; [] |130| 
;* --------------------------------------------------------------------------*
$C$L2:    
...
$C$L3:    
	.dwpsn	file "../keyboard_control_main_capstone.c",line 132,column 16,is_stmt,isa 0
        ...
        JNE       $C$L5                 ; [] |132| 
                                          ; [] |132| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../keyboard_control_main_capstone.c",line 133,column 1,is_stmt,isa 0
        CMP.B     #1,&sw_trigger_flag+0 ; [] |133| 
        JNE       $C$L4                 ; [] |133| 
                                          ; [] |133| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../keyboard_control_main_capstone.c",line 133,column 31,is_stmt,isa 0
        BIC.B     #4,&P3OUT+0           ; [] |133| 
;* --------------------------------------------------------------------------*
$C$L4:    
	.dwpsn	file "../keyboard_control_main_capstone.c",line 134,column 13,is_stmt,isa 0
        MOV.W     #1500,&duty_cycle+0   ; [] |134| 
        JMP       $C$L7                 ; [] 
                                          ; [] 
;* --------------------------------------------------------------------------*
$C$L5:    
	.dwpsn	file "../keyboard_control_main_capstone.c",line 135,column 16,is_stmt,isa 0
        CMP.W     #51,&UCA1RXBUF+0      ; [] |135| 
        JNE       $C$L7                 ; [] |135| 
                                          ; [] |135| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../keyboard_control_main_capstone.c",line 136,column 1,is_stmt,isa 0
        CMP.B     #1,&sw_trigger_flag+0 ; [] |136| 
        JNE       $C$L6                 ; [] |136| 
                                          ; [] |136| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../keyboard_control_main_capstone.c",line 136,column 31,is_stmt,isa 0
        OR.B      #4,&P3OUT+0           ; [] |136| 
;* --------------------------------------------------------------------------*
$C$L6:    
	.dwpsn	file "../keyboard_control_main_capstone.c",line 137,column 13,is_stmt,isa 0
        MOV.W     #2000,&duty_cycle+0   ; [] |137| 
;* --------------------------------------------------------------------------*
$C$L7:    
	.dwpsn	file "../keyboard_control_main_capstone.c",line 139,column 9,is_stmt,isa 0
        BIC.W     #1,&UCA1IFG+0         ; [] |139| 
	.dwendtag $C$DW$46

	.dwpsn	file "../keyboard_control_main_capstone.c",line 142,column 1,is_stmt,isa 0
;* --------------------------------------------------------------------------*
$C$L8:    
        ADD.W     #4,SP                 ; [] 
	.dwcfi	cfa_offset, 2
...
$C$DW$49	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../keyboard_control_main_capstone.c",line 147,column 38,is_stmt,address ISR_Port4_SW1,isa 0
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 2
	.dwcfi	save_reg_to_mem, 16, -2
	.dwpsn	file "../keyboard_control_main_capstone.c",line 148,column 5,is_stmt,isa 0
        MOV.B     #1,&sw_trigger_flag+0 ; [] |148| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 149,column 5,is_stmt,isa 0
        BIC.B     #2,&P4IFG+0           ; [] |149| 
	.dwpsn	file "../keyboard_control_main_capstone.c",line 150,column 1,is_stmt,isa 0
