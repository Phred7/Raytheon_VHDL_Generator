...
def disassemble(*, pique_bool: bool = True) -> None:
    ...
    disassembler_input_file_name: str = "test_ASM.out"  # "gen_vhdl.out"  # "Motor_mover_C_with_port_2.out"  # "All_msp_operations.out" # "test_C.out"  # "test_colt_C.out"  # "All_ops_asm.out'  # "Motor_mover_C.out" # "test.out" # "test_ASM.out" # "All_msp_operations.out"
