duty_cycle = duty_cycle + INT_MAX;
min_duty_cycle = min_duty_cycle + INT_MAX;
min_duty_cycle = min_duty_cycle + INT_MAX;
#include <msp430.h> 
...
int main(void)
{
    ...
    // Timer Compare IRQ
    TB0CCTL0 |= CCIE;
           // Enable TB0 CCR0 overflow IRQ
    TB0CCTL0 &= ~CCIFG;
         // Clear CCR0 flag
    TB0CCTL1 |= CCIE;
           // Enable TB0 CCR1 overflow IRQ
    TB0CCTL1 &= ~CCIFG;
         // Clear CCR1 flag
